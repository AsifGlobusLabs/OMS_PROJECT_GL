...
//   // console.log(userData.Employee_Profile);

//   useEffect(() => {
//     const userDataFromSession = JSON.parse(sessionStorage.getItem("userData"));
//     if (userDataFromSession) {
//       // Extract the image URL and set it to the state
...
//             {userData && userData.Employee_Profile && (
//               <img src={userData.Employee_Profile} alt="Employee Profile" />
//             )}
//           </div>
